...
class ActivesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create active" do
    assert_difference("Active.count") do
      post actives_url, params: { active: { barcode: @active.barcode, name: @active.name, serial: @active.serial } }
    end
  ...
  test "should update active" do
    patch active_url(@active), params: { active: { barcode: @active.barcode, name: @active.name, serial: @active.serial } }
