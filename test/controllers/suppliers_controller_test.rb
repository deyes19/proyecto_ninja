...
class SuppliersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create supplier" do
    assert_difference("Supplier.count") do
      post suppliers_url, params: { supplier: { description: @supplier.description, nit: @supplier.nit } }
    end
  ...
  test "should update supplier" do
    patch supplier_url(@supplier), params: { supplier: { description: @supplier.description, nit: @supplier.nit } }
